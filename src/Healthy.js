...
const FamilyDinner = () => {
  ...
  return (
    <div>
        ...
        <p>
            This page provides a list of recipes falling under the category of 'healthy' meals. <br/> 
            Healthy recipes provide meals with the recommended amount of 700 calories (for a full-grown adult).
        </p>
    </div>
  );
};
