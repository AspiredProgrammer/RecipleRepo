                ...
                <div className="Header">
                    <ul>
                        ...
                        <li className="button-19" type="Easy-Dinner">
                            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/easyDinner">
                                Easy Dinner
                            </Link>
                        </li>
                        <li className="button-19" type="Family-Dinner">
                            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/familyDinner">
                                Family Dinner
                            </Link>
                        </li>
                        <li className="button-19" type="Healthy">
                            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/healthy">
                                Healthy
                            </Link>
                        </li>
                        <li className="button-19" type="Nutrition">
                            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/nutrition">
                                Nutritional Analysis
                            </Link>
                        </li>
                        <li className="button-19" type="Food">
                            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/food">
                                Food List
                            </Link>
                        </li>
                    </ul>
